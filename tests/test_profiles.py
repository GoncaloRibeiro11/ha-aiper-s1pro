...
def test_scuba_s1_pro_detected_from_fallback_identity_fields() -> None:
    """S1 Pro payloads can omit Scuba from the canonical model field."""
    profile = derive_device_profile({"model": "Aiper", "modelName": "S1-Pro"})
